  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
        ...
        <button className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full  font-medium cursor-pointer active:scale-95' onClick={()=>navigate('/my-bookings')}>
          Proceed to Checkout
