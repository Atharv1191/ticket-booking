...
//       return toast("This seat is alredy Booked")
//     }
...
//         </div>
//         <button className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full  font-medium cursor-pointer active:scale-95' onClick={bookTickets}>
//           Proceed to Checkout
          ...
          return (
            <button
              ...
              className={`h-8 w-8 rounded border cursor-pointer
                ...
                ${isOccupied ? 'bg-red-500 text-white cursor-not-allowed' : 'border-primary/60'}
              `}
            >
              {seatId}
            </button>
