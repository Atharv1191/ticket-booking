...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen '>
        ...
        <img src={assets.marvelLogo} className='max-h-11 mt-20' alt="" />
        ...
        <p className='max-w-md text-gray-300'>In a post-apcoalyptic world where cities ride on wheels and consume each other to survive, two people meet in London and try to stop a conspiracy.</p>
