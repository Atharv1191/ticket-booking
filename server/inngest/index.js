          ...
          sendEmail({
            ...
            body: `
              <div style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p>is scheduled for 
                  <strong>${new Date(task.showTime).toLocaleDateString("en-US", { timeZone: "Asia/Kolkata" })}</strong> at 
...
const functions = [syncUserCreation, syncUserDeletion, syncUserUpdation, releaseSeatsAndDeleteBokking,sendBookingConfirmationEmail,sendShowReminders,sendNewShowNtifications];
